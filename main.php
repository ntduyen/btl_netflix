...
<div class="tv-dramas ">
    ...
    <!-- <a href="./CSS/image/videodemo.video.mp4">
            <img src="./CSS/image/filmtaixeandanh.png" title="Học lập trình"/>
    </a> -->
    <!-- <div class="orange">
        <img src="./CSS/image/filmtaixeandanh.png" alt="orange image">
    </div> -->
...
<div class="tv-dramas ">
    <h2 class="tvd-h2" >Phim giàu trí tưởng tượng</h2>
    <div class="div-width">
    <div class="all-movie-div filtering">
...
<!-- <div class="trending-now">
    ...
    <div class="second-div-width">
        <div class="second-all-movie-div filtering">
    <div class="control-z" id="controz">
...
<!-- <div class="my-list" id="list">
    ...
    <div class="list-div-width">
        <div class="second-div-list filtering">
...
<!-- only on netflix -->
<!-- <div class="only-on-netflix" id="only-on-netflix">
    <h2 class="tvtvd-h2">Only On Netflix</h2>
    <div class="netflix-div-width">
        <div class="netflix-all-movie-div filtering">
            <div class="nevertheless-list">
...
<!-- <div class="top10-now">
    ...
    <div class="top10-div-width">
        <div class="top10-all-movie-div filtering">
...
<script>
  ...
  slidesToScroll: 2, // số phần tử mỗi lần lướt sang
